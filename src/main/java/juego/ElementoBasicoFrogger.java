...
public abstract class ElementoBasicoFrogger implements ElementoFrogger {
	...
	public ElementoBasicoFrogger (int posicionX, int posicionY, double velocidadX, double velocidadY, int ancho, int largo, Color color) {
